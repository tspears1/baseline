...
export default css`
  ...
  .code-preview {
    --_code-preview-helper-inset: var(
      --code-preview-helper-inset,
      -0.75rem -0.75rem auto auto
    );
    --_code-preview-helper-position: var(
      --code-preview-helper-position,
      absolute
    );
  ...
  .code-preview__preview {
    background-color: var(
      --code-preview-background-color,
      var(--eos-color-neutral-1000)
    );
    border-bottom: none;
    ...
    min-inline-size: calc(
      23.4375rem + (var(--_code-preview-trigger-width) * 2) +
        (var(--_code-preview-padding-inline) * 2)
    );
    padding-block: var(--code-preview-padding-block, 1.5rem);
    padding-inline: calc(
      var(--_code-preview-padding-inline) + var(--_code-preview-trigger-width)
    );
    position: relative;
    z-index: 3;
  }
  ...
  .code-preview__resizer {
    ...
    align-items: center;
    background-color: var(
      --code-preview-trigger-background-color,
      var(--eos-color-neutral-0)
    );
    border: var(
      --code-preview-trigger-right-border,
      var(--code-preview-trigger-border, none)
    );
    bottom: 0;
    box-shadow: none;
  ...
  .code-preview__resizer:where([data-preview-resizer="start"]) {
    border: var(
      --code-preview-trigger-left-border,
      var(--code-preview-trigger-border, none)
    );
    left: 0;
    right: auto;
