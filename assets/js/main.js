...
// Arrow Navigation ==========================//
const arrowNavigationElements = [...document.querySelectorAll('[data-arrow-navigation]')]

if (arrowNavigationElements.length) {
  const { ArrowNavigation } = await import('@js/modules/arrowNavigation')
  arrowNavigationElements.forEach(arrowNavigationElement => new ArrowNavigation(arrowNavigationElement))
}
